...
export function TemplatePreview({ templateId }: { templateId: string }) {
  ...
  return <main><header className="preview-bar"><a href="/templates">← 返回模板</a><span>模板预览 · Mock 数据</span><a className="studio-link-button" href="/templates">使用此模板请返回列表</a></header><StudioDocument document={document} /></main>;
}
