...
export function TrackingNotFound() {
  return <section aria-label="Order not found" role="status" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: "80px 24px", gap: 16 }}>
